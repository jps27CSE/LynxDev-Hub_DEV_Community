...
import { DIFFICULTY_ORDER, difficultyDotClass } from "@/lib/interview-ui";
...
export default function ChapterHubClient(props: ChapterHubProps) {
  return (
