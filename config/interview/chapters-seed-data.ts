  ...
  "frontend-engineer": [
    {
      ...
      content: {
        overview:
          "JavaScript is the language of the web. This chapter covers the core concepts that every frontend interview tests: closures, event loop, prototypes, promises, and async patterns.",
        realLifeScenario:
    ...
    },
    {
      ...
      content: {
        overview:
          "CSS is deceptively complex. Modern interviews test not just Flexbox and Grid, but your understanding of layout algorithms, specificity, animations, and performance.",
        realLifeScenario:
